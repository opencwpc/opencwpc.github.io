	...
	*/
	...
	function c(t, n = globalThis, r = ["*"]) {
		n.addEventListener("message", function o(u) {
			...
			if (!function(e, t) {
				...
				return !1;
			}(r, u.origin)) return void console.warn(`Invalid origin '${u.origin}' for comlink proxy`);
	...
	function C(e, t, n) {
		...
		return Number.isFinite(s) ? {
			...
			n: n ?? 0,
			p: s
		} : (L++, L <= 5 && console.warn("[hlL2] 丢弃价格无法解析的档位", e, t), null);
	}
	let L = 0;
	function N(e, t, n, s) {
		const i = k.get(e);
	...
	function A(e) {
		...
		if (t.s && "object" == typeof t.s && t.s.levels) {
			...
			return function(e, t, n) {
				...
				if (r) {
					M.delete(e);
					for (const t of r) N(e, t.l, t.r, t.spread);
				}
			}(e.coin, e.levels, e.spread), Promise.resolve(x(e.coin));
		}
		if (t.u && "object" == typeof t.u && t.u.c) {
			const e = t.u;
			return N(e.c, e.l, e.r, e.s), Promise.resolve(x(e.c));
		}
		if (t.l || t.r) {
			const e = t.c;
			return e ? (N(e, t.l, t.r, t.s), Promise.resolve(x(e))) : Promise.resolve(null);
		}
		...
		createWebSocket(e) {
			...
			try {
				this.ws = new WebSocket(this.url, this.protocols), this.ws.onopen = () => {
					...
					t && ("hl" !== this.parseMode || "l2" !== t.channel ? this.msgCallback?.(t) : A(t).then((e) => {
