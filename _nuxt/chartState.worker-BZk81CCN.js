(function() {
	var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, o = Object.getPrototypeOf, i = Object.prototype.hasOwnProperty, a = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), u = (a, u, c) => (c = null != a ? e(o(a)) : {}, ((e, o, a, u) => {
		if (o && "object" == typeof o || "function" == typeof o) for (var c, s = r(o), f = 0, l = s.length; f < l; f++) c = s[f], i.call(e, c) || c === a || t(e, c, {
			get: ((e) => o[e]).bind(null, c),
			enumerable: !(u = n(o, c)) || u.enumerable
		});
		return e;
	})(!u && a && a.__esModule && i.call(a, "default") ? c : t(c, "default", {
		value: a,
		enumerable: !0
	}), a));
	/**
	...
	*/
	const c = Symbol("Comlink.proxy"), s = Symbol("Comlink.endpoint"), f = Symbol("Comlink.releaseProxy"), l = Symbol("Comlink.finalizer"), d = Symbol("Comlink.thrown"), v = (e) => "object" == typeof e && null !== e || "function" == typeof e, h = /* @__PURE__ */ new Map([["proxy", {
		canHandle: (e) => v(e) && e[c],
		serialize(e) {
	...
	function p(e, t = globalThis, n = ["*"]) {
		t.addEventListener("message", function r(o) {
			...
			const { id: i, type: a, path: u } = Object.assign({ path: [] }, o.data), s = (o.data.argumentList || []).map(j);
			let f;
			try {
				const t = u.slice(0, -1).reduce((e, t) => e[t], e), n = u.reduce((e, t) => e[t], e);
				switch (a) {
					case "GET":
						f = n;
						break;
					case "SET":
						t[u.slice(-1)[0]] = j(o.data.value), f = !0;
						break;
					case "APPLY":
						f = n.apply(t, s);
						break;
			...
			Promise.resolve(f).catch((e) => ({
				...
				const [o, u] = E(n);
				t.postMessage(Object.assign(Object.assign({}, o), { id: i }), u), "RELEASE" === a && (t.removeEventListener("message", r), y(t), l in e && "function" == typeof e[l] && e[l]());
			}).catch((e) => {
				const [n, r] = E({
	...
	function m(e) {
		return N(e, /* @__PURE__ */ new Map(), { type: "RELEASE" }).then(() => {
			y(e);
		});
	}
	const g = /* @__PURE__ */ new WeakMap(), _ = "FinalizationRegistry" in globalThis && new FinalizationRegistry((e) => {
		const t = (g.get(e) || 0) - 1;
		g.set(e, t), 0 === t && m(e);
	});
	function w(e, t, n = [], r = function() {}) {
		...
		const i = new Proxy(r, {
			...
			apply(r, i, a) {
				...
				if (u === s) return N(e, t, { type: "ENDPOINT" }).then(j);
				if ("bind" === u) return w(e, t, n.slice(0, -1));
				const [c, f] = S(a);
				return N(e, t, {
					type: "APPLY",
					path: n.map((e) => e.toString()),
	...
	function E(e) {
		for (const [t, n] of h) if (n.canHandle(e)) {
	...
	function N(e, t, n, r) {
		return new Promise((o) => {
			...
			t.set(i, o), e.start && e.start(), e.postMessage(Object.assign({ id: i }, n), r);
		});
	}
	var A = u(a((e, t) => {
		/*!
		...
		*/
		(function(n) {
			if ("object" == typeof e && void 0 !== t) t.exports = n();
			else if ("function" == typeof define && define.amd) define([], n);
			else ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).localforage = n();
		})(function() {
			return function e(t, n, r) {
				function o(a, u) {
					if (!n[a]) {
						if (!t[a]) {
							...
							if (!u && c) return c(a, !0);
							if (i) return i(a, !0);
							var s = /* @__PURE__ */ new Error("Cannot find module '" + a + "'");
				...
				1: [function(e, t, n) {
					(function(e) {
						...
						if (o) {
							var i = 0, a = new o(f), u = e.document.createTextNode("");
				...
				2: [function(e, t, n) {
					...
					var r = e(1);
					function o() {}
					var i = {}, a = ["REJECTED"], u = ["FULFILLED"], c = ["PENDING"];
					function s(e) {
					...
					function l(e, t, n) {
						r(function() {
							...
							r === e ? i.reject(e, /* @__PURE__ */ new TypeError("Cannot resolve promise with itself")) : i.resolve(e, r);
						});
					}
					function d(e) {
						var t = e && e.then;
					...
					t.exports = s, s.prototype.catch = function(e) {
						...
						return this.state !== c ? l(n, this.state === u ? e : t, this.outcome) : this.queue.push(new f(n, e, t)), n;
						...
						var a = new Array(n), u = 0, c = -1, s = new this(o);
						for (; ++c < n;) f(e[c], c);
						return s;
						function f(e, o) {
				...
				4: [function(e, t, n) {
					...
					var l = "local-forage-detect-blob-support", d = void 0, v = {}, h = Object.prototype.toString, p = "readonly", y = "readwrite";
					function b(e) {
					...
					function N(e) {
						return i([b(atob(e.data))], { type: e.type });
					}
					function O(e) {
					...
					var k = {
						...
						_initStorage: function(e) {
							...
							o || (o = {
								...
								dbReady: null,
								deferredOperations: []
							}, v[n.name] = o), o.forages.push(t), t._initReady || (t._initReady = t.ready, t.ready = A);
							var i = [];
							function u() {
								return a.resolve();
							}
							...
							return a.all(i).then(function() {
								...
								return n.db = e, j(n, t._defaultConfig.version) ? E(n) : e;
							}).then(function(e) {
									...
									R(r._dbInfo, y, function(i, a) {
										...
										try {
											...
											a.oncomplete = function() {
												...
												o(c.error ? c.error : c.transaction.error);
											};
										} catch (s) {
											o(s);
										}
							...
							var n = this, r = new a(function(t, r) {
								e < 0 ? t(null) : n.ready().then(function() {
									R(n._dbInfo, p, function(o, i) {
										if (o) return r(o);
										try {
											var a = i.objectStore(n._dbInfo.storeName), u = !1, c = a.openKeyCursor();
						...
						dropInstance: function(e, t) {
							...
							if ((e = "function" != typeof e && e || {}).name || (e.name = e.name || r.name, e.storeName = e.storeName || r.storeName), e.name) {
								var i = e.name === r.name && this._dbInfo.db ? a.resolve(this._dbInfo.db) : I(e).then(function(t) {
					...
					var x = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", D = /^~~local_forage_type~([^~]+)~/, C = "__lfsc__:", T = "arbf", B = "blob", M = "si08", P = "ui08", L = "uic8", F = "si16", z = "si32", U = "ur16", q = "ui32", W = "fl32", H = "fl64", G = Object.prototype.toString;
					function K(e) {
						var t, n, r, o, i, a = .75 * e.length, u = e.length, c = 0;
						"=" === e[e.length - 1] && (a--, "=" === e[e.length - 2] && a--);
						var s = new ArrayBuffer(a), f = new Uint8Array(s);
						for (t = 0; t < u; t += 4) n = x.indexOf(e[t]), r = x.indexOf(e[t + 1]), o = x.indexOf(e[t + 2]), i = x.indexOf(e[t + 3]), f[c++] = n << 2 | r >> 4, f[c++] = (15 & r) << 4 | o >> 2, f[c++] = (3 & o) << 6 | 63 & i;
						return s;
					}
					function Q(e) {
					...
					var X = {
						serialize: function(e, t) {
							...
							if (e && (n = G.call(e)), e && ("[object ArrayBuffer]" === n || e.buffer && "[object ArrayBuffer]" === G.call(e.buffer))) {
								var r, o = C;
								e instanceof ArrayBuffer ? (r = e, o += T) : (r = e.buffer, "[object Int8Array]" === n ? o += M : "[object Uint8Array]" === n ? o += P : "[object Uint8ClampedArray]" === n ? o += L : "[object Int16Array]" === n ? o += F : "[object Uint16Array]" === n ? o += U : "[object Int32Array]" === n ? o += z : "[object Uint32Array]" === n ? o += q : "[object Float32Array]" === n ? o += W : "[object Float64Array]" === n ? o += H : t(/* @__PURE__ */ new Error("Failed to get type for BinaryArray"))), t(o + Q(r));
							} else if ("[object Blob]" === n) {
								var i = new FileReader();
								i.onload = function() {
									var n = "~~local_forage_type~" + e.type + "~" + Q(this.result);
									t(C + B + n);
						...
						deserialize: function(e) {
							...
							switch (r) {
								case T: return a;
								case B: return i([a], { type: t });
								case M: return new Int8Array(a);
								case P: return new Uint8Array(a);
								case L: return new Uint8ClampedArray(a);
								case F: return new Int16Array(a);
								case U: return new Uint16Array(a);
								case z: return new Int32Array(a);
								case q: return new Uint32Array(a);
								case W: return new Float32Array(a);
								case H: return new Float64Array(a);
					...
					function Y(e, t, n, r, o, i) {
						e.executeSql(n, r, o, function(e, a) {
							a.code === a.SYNTAX_ERR ? e.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [t.storeName], function(e, u) {
								u.rows.length ? i(e, a) : J(e, t, function() {
								...
								c.serializer.serialize(t, function(t, s) {
									s ? a(s) : c.db.transaction(function(n) {
										...
										if (t.code === t.QUOTA_ERR) {
											if (r > 0) return void i(V.apply(o, [
												e,
												u,
												n,
												r - 1
					...
					var Z = {
									...
									o.db.transaction(function(n) {
										Y(n, o, "SELECT * FROM " + o.storeName, [], function(n, r) {
											for (var i = r.rows, a = i.length, u = 0; u < a; u++) {
												var c = i.item(u), s = c.value;
												if (s && (s = o.serializer.deserialize(s)), void 0 !== (s = e(s, c.key, u + 1))) return void t(s);
											}
											t();
										}, function(e, t) {
											r(t);
						...
						dropInstance: function(e, t) {
							...
							return u(r = e.name ? new a(function(t) {
								var r = e.name === n.name ? o._dbInfo.db : openDatabase(e.name, "", "", 0);
								e.storeName ? t({
									db: r,
					...
					var te = {
						...
						_initStorage: function(e) {
							...
							return t.keyPrefix = $(e, this._defaultConfig), ee() ? (this._dbInfo = t, t.serializer = X, a.resolve()) : a.reject();
						},
						_support: function() {
							try {
						...
						dropInstance: function(e, t) {
							...
							var r, o = this;
							return r = e.name ? new a(function(t) {
							...
							}) : a.reject("Invalid arguments"), u(r, t), r;
						}
					}, ne = function(e, t) {
					...
					function ve() {
						for (var e = 1; e < arguments.length; e++) {
							var t = arguments[e];
							if (t) for (var n in t) t.hasOwnProperty(n) && (oe(t[n]) ? arguments[0][n] = t[n].slice() : arguments[0][n] = t[n]);
						}
						return arguments[0];
					}
					t.exports = new (function() {
						function e(t) {
							...
							}(this, e), ue) if (ue.hasOwnProperty(n)) {
								var r = ue[n], o = r._driver;
						...
						return e.prototype.config = function(e) {
							...
							var r = new a(function(t, n) {
								try {
									var r = e._driver, o = /* @__PURE__ */ new Error("Custom driver not compliant; see https://mozilla.github.io/localForage/#definedriver");
									if (!e._driver) return void n(o);
									for (var i = fe.concat("_initStorage"), c = 0, s = i.length; c < s; c++) {
										var f = i[c];
										if ((!re(se, f) || e[f]) && "function" != typeof e[f]) return void n(o);
									}
									(function() {
										for (var t = function(e) {
											return function() {
												var t = /* @__PURE__ */ new Error("Method " + e + " is not implemented by the current driver"), n = a.reject(t);
							...
							var r = ie[e] ? a.resolve(ie[e]) : a.reject(/* @__PURE__ */ new Error("Driver not found."));
							return c(r, t, n), r;
									...
									r._driver = e._driver, i(), r._wrapLibraryMethodsWithReady(), r._initDriver = function(e) {
										return function() {
											...
											return function n() {
												...
												i();
												var c = /* @__PURE__ */ new Error("No available storage method found.");
	...
	function k(e, t = "") {
		return e ? Object.keys(e).reduce((n, r) => {
			const o = t.length ? t + "." : "";
			return "object" == typeof e[r] && null !== e[r] && !Array.isArray(e[r]) && Object.keys(e[r]).length > 0 ? Object.assign(n, k(e[r], o + r)) : n[o + r] = e[r], n;
		}, {}) : {};
	}
	p({
		getFullStorage: async (e) => await A.default.getItem(e) || {},
		async getChartState(e, t) {
			const n = await this.getFullStorage(e);
			return {
				saved: n[t] || null,
				allStudies: n.allStudies || []
			};
		},
		async saveChart(e, t, n, r = !1) {
			const o = R.then(() => this._executeSave(e, t, n, r));
			return R = o.catch(() => {}), o;
		},
		async _executeSave(e, t, n, r) {
			let o = !1;
			const i = [];
			if (n.charts.forEach((e) => {
				e.panes.forEach((e) => {
					e.sources.forEach((e) => {
						e.type?.includes("LineTool") && (o = !0);
						const t = /study/i.test(e.type || ""), n = /volume/i.test(e.type || "");
						if (t && !n && e.metaInfo) {
							const t = e.state || {}, n = k(t.styles, "styles");
							void 0 !== t.precision && (n.precision = t.precision), i.push({
			...
			}), !o && !r) return { status: "skipped" };
			const a = Array.from(new Map(i.map((e) => [JSON.stringify(e), e])).values()), u = await this.getFullStorage(e);
			if (!o) return Reflect.deleteProperty(u, t), u.allStudies = a, await A.default.setItem(e, u), { status: "cleaned" };
			n.charts.forEach((e) => {
				e.panes.forEach((e) => {
			...
			const c = Object.keys(u).filter((e) => "allStudies" !== e);
			if (c.length > 100) {
				const e = c.reduce((e, t) => (u[e]._lastModified || 0) < (u[t]._lastModified || 0) ? e : t);
				Reflect.deleteProperty(u, e);
			}
			return await A.default.setItem(e, u), { status: "saved" };
		},
		async removeChart(e, t) {
			const n = await this.getFullStorage(e);
			return !!n[t] && (Reflect.deleteProperty(n, t), await A.default.setItem(e, n), !0);
		},
		clearAll: async (e) => A.default.removeItem(e)
	});
})();
