(function() {
	var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, o = Object.getPrototypeOf, i = Object.prototype.hasOwnProperty, a = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), u = (a, u, c) => (c = null != a ? e(o(a)) : {}, ((e, o, a, u) => {
		if (o && "object" == typeof o || "function" == typeof o) for (var c, f = r(o), s = 0, l = f.length; s < l; s++) c = f[s], i.call(e, c) || c === a || t(e, c, {
	...
	*/
	const c = Symbol("Comlink.proxy"), f = Symbol("Comlink.endpoint"), s = Symbol("Comlink.releaseProxy"), l = Symbol("Comlink.finalizer"), d = Symbol("Comlink.thrown"), v = (e) => "object" == typeof e && null !== e || "function" == typeof e, h = /* @__PURE__ */ new Map([["proxy", {
		canHandle: (e) => v(e) && e[c],
		serialize(e) {
	...
	function p(e, t = globalThis, n = ["*"]) {
		t.addEventListener("message", function r(o) {
			...
			const { id: i, type: a, path: u } = Object.assign({ path: [] }, o.data), f = (o.data.argumentList || []).map(j);
			let s;
			try {
				...
				switch (a) {
					case "GET":
						...
						break;
					case "SET":
						t[u.slice(-1)[0]] = j(o.data.value), s = !0;
						break;
					case "APPLY":
						s = n.apply(t, f);
						break;
	...
	function w(e, t, n = [], r = function() {}) {
		...
		const i = new Proxy(r, {
			...
			apply(r, i, a) {
				...
				if (u === f) return N(e, t, { type: "ENDPOINT" }).then(j);
			...
			return function e(t, n, r) {
				function o(a, u) {
					if (!n[a]) {
						if (!t[a]) {
							...
							if (!u && c) return c(a, !0);
							if (i) return i(a, !0);
							var f = /* @__PURE__ */ new Error("Cannot find module '" + a + "'");
				...
				1: [function(e, t, n) {
					(function(e) {
						...
						if (o) {
							var i = 0, a = new o(s), u = e.document.createTextNode("");
				...
				4: [function(e, t, n) {
								...
								n = e.storeName ? i.then(function(t) {
									...
									return new a(function(t, n) {
										...
										r.onerror = function() {
											var e = r.result;
											e && e.close(), n(r.error);
										}, r.onblocked = function() {}, r.onsuccess = function() {
											var e = r.result;
											e && e.close(), t(e);
										};
									}).then(function(e) {
					...
					var D = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", x = /^~~local_forage_type~([^~]+)~/, C = "__lfsc__:", T = "arbf", B = "blob", M = "si08", P = "ui08", L = "uic8", F = "si16", z = "si32", U = "ur16", q = "ui32", W = "fl32", H = "fl64", G = Object.prototype.toString;
					function K(e) {
						var t, n, r, o, i, a = .75 * e.length, u = e.length, c = 0;
						"=" === e[e.length - 1] && (a--, "=" === e[e.length - 2] && a--);
						var f = new ArrayBuffer(a), s = new Uint8Array(f);
						for (t = 0; t < u; t += 4) n = D.indexOf(e[t]), r = D.indexOf(e[t + 1]), o = D.indexOf(e[t + 2]), i = D.indexOf(e[t + 3]), s[c++] = n << 2 | r >> 4, s[c++] = (15 & r) << 4 | o >> 2, s[c++] = (3 & o) << 6 | 63 & i;
						return f;
					}
					function Q(e) {
					...
					function J(e, t, n, r, o, i) {
						e.executeSql(n, r, o, function(e, a) {
							a.code === a.SYNTAX_ERR ? e.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [t.storeName], function(e, u) {
								u.rows.length ? i(e, a) : Y(e, t, function() {
							...
							o.ready().then(function() {
								...
								c.serializer.serialize(t, function(t, f) {
									f ? a(f) : c.db.transaction(function(n) {
										J(n, c, "INSERT OR REPLACE INTO " + c.storeName + " (key, value) VALUES (?, ?)", [e, t], function() {
											i(u);
										}, function(e, t) {
											a(t);
										});
						...
						return e.prototype.config = function(e) {
							...
							var r = new a(function(t, n) {
								try {
									...
									for (var i = se.concat("_initStorage"), c = 0, f = i.length; c < f; c++) {
										var s = i[c];
										if ((!re(fe, s) || e[s]) && "function" != typeof e[s]) return void n(o);
									}
									(function() {
							...
							for (var e = 0, t = se.length; e < t; e++) de(this, se[e]);
